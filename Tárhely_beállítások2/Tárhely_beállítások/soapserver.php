...
class Szolgaltatas {
    ...
    public function getadatok($novekvo=1){
        ...
        "markak" => Array());
        try {
        $dbh = new PDO('mysql:host=localhost;dbname=szaszweb2','szaszweb2', 'Mysqljelszo_71', array(PDO::ATTR_ERRMODE=>PDO::ERRMODE_EXCEPTION));
...
$options = array('uri' => 'http://szaszandras.nhely.hu/szerver/soapServer.php');
