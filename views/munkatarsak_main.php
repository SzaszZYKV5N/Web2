<div class="doctores_section margim_90">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <h1 class="doctores_taital">Munkatársaink</h1>
               </div>
            </div>
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              <div class="doctores_box">
                                 ...
                                 <h4 class="humour_text">Ica <br><span class="mbbs_text">Munkafelvevő</span></h4>
                           ...
                           <div class="col-md-4">
                              <div class="doctores_box">
                                 ...
                                 <h4 class="humour_text">Jenni <br><span class="mbbs_text">Takarító</span></h4>
                                 <div class="social_icon">
                                    <ul>
                                       <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                       <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                           ...
                           <div class="col-md-4">
                              <div class="doctores_box">
                                 ...
                                 <h4 class="humour_text">Jani <br><span class="mbbs_text">Mindenes</span></h4>
                                 <div class="social_icon">
                                    <ul>
                                       <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                       <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
